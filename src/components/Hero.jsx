        ...
        <div className='flex flex-wrap lg:flex-row-reverse'>
            <div className='w-full lg:w-1/2'>
                <div className='flex justify-center lg:p-8 w-full'>
                    ...
                    src={myPhoto} 
                    alt="photo" 
                    className='border border-stone-900 rounded-3xl w-[70%] h-[400px] object-cover'
            ...
            <div className='w-full lg:w-1/2'>
                ...
                className='flex flex-col items-center lg:items-start mt-10'>
                    ...
                    <motion.a
                    variants={childVariants}
                    href="../../resume.pdf" target='_blank' rel='noopener noreferrer' download='resume' className='bg-white rounded-full p-4 text-sm text-stone-800 mb-10'>Download Resume</motion.a>
                </motion.div>
            </div>
        </div>
    </div>
